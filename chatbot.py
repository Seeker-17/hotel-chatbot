...
def predict_class(sentence):
    ...
    ERROR_THRESHOLD = 0.10  # Umbral de confianza. Si una predicción tiene una probabilidad menor a esto, se ignora.
...
def get_response(intents_list, intents_json, user_message=None):
    ...
    for i in list_of_intents:
        ...
        if i['tag'] == tag:
            ...
            break # Sale del bucle una vez que encuentra la etiqueta y elige una respuesta.
    return result
